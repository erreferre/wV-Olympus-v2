...
function startConsultaServidor(){
    var newHTML1;
    var newHTMLshow, newHTMLshowb1, newHTMLshowb2, newHTMLshowb4, newHTMLshowb5;
    var newHTMLselfie;
    var data;
    var val;
    	...
    	$.each(data, function(key, val) {
		    ...
		    if (comienzashow === 0) {
                ...
                newHTMLshowb4 = '<p><button width="100%" class="boton-negro boton-centro boton-text-all-color" type="button" \
        			...
        			<h1>::::::::::::::::::::::::::<br/>velázquez<br/>::::::::::::::::::::::::::<br/></h1></button></p>';
                newHTMLshowb5 = '<p><button width="100%" class="boton-negro boton-centro boton-text-all-color" type="button" \
        			...
        			<h1>::::::::::::::::::::::::::<br/>momento charramangueiro<br/>::::::::::::::::::::::::::<br/></h1></button></p>';
        		newHTMLselfie = '';
